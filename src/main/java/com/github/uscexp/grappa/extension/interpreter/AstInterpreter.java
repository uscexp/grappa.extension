...
/**
 * The {@link AstInterpreter} interpretes a PEG defined language, based on
 * {@link BaseParser}. It takes an AST (Abstract Syntax Tree) based on the
 * parsing and the annotated parser methods, annotated with {@link AstValue} or
 * {@link AstCommand}. {@link AstValue} writes the parse node value to the
 * interpreter stack. By default the interpreter stores the values as
